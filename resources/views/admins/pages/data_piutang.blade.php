...
@section('title','SIA | Data Piutang')

@section('content-header', 'Data Piutang')
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <p class="card-title"><b>Data Piutang</b></p>
          </div>
          <div class="card-body">
            <button class="btn btn-primary btn-md" data-toggle="modal" data-target="#modal_tambah_data_piutang">
              <i class="fa fa-plus"></i><span></span>
            </button>

            <button class="btn btn-primary btn-md" data-toggle="modal" data-target="#modal_cari_data_piutang">
              <i class="fa fa-filter"></i><span></span>
            </button>

            <div class="row text-center">
              <div class="modal fade modal-success" id="modal_tambah_data_piutang" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Tambah Data Piutang</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <div class="modal-body text-left">
                      <form method="post" action="/data_piutang/tambah">
                        {{csrf_field()}}

                        <div class="form-group">
                          <label for="tgl_transaksi">Tanggal Piutang</label>
                          <input required="" name="tgl_transaksi" type="date" class="form-control" id="tgl_transaksi ">
                        </div>

                        
                        <input type="number" hidden="" name="daftar_akun" value="5">
            ...
            <div class="row text-center">
              <div class="modal fade modal-success" id="modal_cari_data_piutang" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body text-left">
                      <form method="post" action="/data_piutang/cari">
                        {{csrf_field()}}
            ...
            <table id="example1" class="table table-bordered table-striped myTable dtr-inline collapsed text-center" role="grid" aria-describedby="example1_info">
              ...
              <tbody>
                <tr class="odd">
                  ...
                  <td>
                    <!-- <button type="button" class="btn btn" data-toggle="modal" data-target="#myModalUbahDataPiutang{{$p -> id}}">
                ...
                <!-- Modal -->
                <div class="modal" id="myModalUbahDataPiutang{{$p -> id}}">
                  <div class="modal-dialog">
                    <div class="modal-content">

                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Ubah Data Piutang</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div> 
                      <!-- Modal body -->
                      <div class="modal-body text-left">
                        <form method="post" action="/data_piutang/ubah/{{$p -> id}}">
                          {{csrf_field()}}
